...
\begin{document}
	...
	\begin{itemize}[nosep]
		...
		\item[\textbf{FA80}]\textbf{Veranstaltung erstellen}
		...
		\item[\textbf{FA120}]\textbf{Veranstaltung bearbeiten}
	...
	\begin{itemize}[nosep]
		...
		\begin{enumerate}[nosep]
			...
			\item Beitrag wird auf dem Feed der abonnenten des Nutzers angezeigt
		\end{enumerate}
		\textbf{Nachbedingungen (Fehlschlag):}
		\newline \textbf{Akteure:} Nutzer
		\newline \textbf{Auslösendes Ereignis:} Anfrage des Nutzers
		...
		\begin{enumerate}[nosep]
			...
			\item Aktion bestätigen
			\item Anzeigen einer Bestätigungsnachricht
			\item Beitrag verschwindet aus dem Feed\\
		\end{enumerate}
